...
type IntentEnhancementConfig struct {
	// EnableContextEnhancement 启用上下文增�
	// 当启用时，系统会从历史分析记录中检索上下文信息来增强意图建�
	...
	// CacheSimilarityThreshold 缓存相似度阈�
...
// DefaultIntentEnhancementConfig 返回默认的意图增强配�
// 默认情况下所有增强功能都启用，使用推荐的参数�
