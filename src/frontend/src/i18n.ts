...
export const translations: Record<Language, Record<string, string>> = {
    'English': {
        ...
        'checking_chrome': 'Checking Chrome Browser...',
        ...
        // Chrome Required
        'chrome_required_title': 'Chrome Browser Required',
        'chrome_required_subtitle': 'Web search functionality requires Chrome',
        'chrome_required_message': 'This application uses Chrome browser for web search capabilities. Please install Chrome or Chromium to continue.',
        'installation_steps': 'Installation Steps',
        'chrome_step_1': 'Click "Download Chrome" button below to open the download page',
        'chrome_step_2': 'Download and install Chrome browser',
        'chrome_step_3': 'Click "Retry Check" after installation completes',
        'note': 'Note',
        'chrome_note': 'If Chrome is already installed but not detected, please ensure it is installed in the default location and restart the application.',
    ...
    '简体中文': {
        ...
        // Chrome必需
        'chrome_required_title': '需要Chrome浏览器',
        'chrome_required_subtitle': 'Web搜索功能需要Chrome支持',
        'chrome_required_message': '本应用使用Chrome浏览器实现Web搜索功能。请安装Chrome或Chromium以继续使用。',
        'installation_steps': '安装步骤',
        'chrome_step_1': '点击下方"下载Chrome"按钮打开下载页面',
        'chrome_step_2': '下载并安装Chrome浏览器',
        'chrome_step_3': '安装完成后点击"重新检测"',
        'note': '注意',
        'chrome_note': '如果Chrome已安装但未检测到，请确保安装在默认位置并重启应用程序。',
