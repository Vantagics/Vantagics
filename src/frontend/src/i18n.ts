...
export const translations: Record<Language, Record<string, string>> = {
    'English': {
        ...
        'onboarding_self_import_desc': 'Supports Excel, CSV, JSON files, or connect to MySQL, PostgreSQL databases',
    ...
    '简体中文': {
        ...
        'onboarding_or': '或者',
        'onboarding_self_import': '自主导入数据',
        'onboarding_self_import_desc': '支持 Excel、CSV、JSON 文件，或连接 MySQL、PostgreSQL 数据库',
