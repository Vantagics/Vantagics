...
import { Download, Briefcase, Brain } from 'lucide-react';
...
interface ChatThreadContextMenuProps {
    ...
    threadId: string;
    onClose: () => void;
    onAction: (action: 'export' | 'assetize' | 'view_memory', threadId: string) => void;
}
...
const ChatThreadContextMenu: React.FC<ChatThreadContextMenuProps> = ({ position, threadId, onClose, onAction }) => {
    ...
    const handleAction = (action: 'export' | 'assetize' | 'view_memory') => {
