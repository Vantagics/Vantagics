...
const ExportDataSourceModal: React.FC<ExportDataSourceModalProps> = ({ isOpen, sourceId, sourceName, onClose, dataSource }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-[#252526] w-[500px] rounded-xl shadow-2xl overflow-hidden text-slate-900 dark:text-[#d4d4d4] p-6 flex flex-col max-h-[90vh]">
                ...
                <div className="mt-6 flex justify-end gap-3 pt-4 border-t border-slate-100 dark:border-[#3c3c3c]">
                    <button
                        onClick={onClose}
