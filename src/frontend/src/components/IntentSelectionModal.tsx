...
const IntentSelectionModal: React.FC<IntentSelectionModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-[#252526] rounded-xl shadow-2xl max-w-2xl w-full mx-4 max-h-[80vh] flex flex-col">
                {/* Header */}
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-slate-100 dark:bg-[#3c3c3c] text-slate-600 dark:text-[#d4d4d4] text-xs font-medium group-hover:bg-blue-100 dark:group-hover:bg-[#1e3a5f] group-hover:text-blue-600 dark:group-hover:text-[#569cd6]">
                                                {index + 1}
                                            </span>
                                            <h4 className="font-semibold text-slate-900 dark:text-[#d4d4d4] group-hover:text-blue-600">
                                                {suggestion.title}
                                            </h4>
                                        </div>
                                        <p className="text-sm text-slate-600 dark:text-[#9d9d9d] leading-relaxed">
                ...
                {/* Footer */}
                <div className="flex items-center justify-between p-6 border-t border-slate-200 dark:border-[#3c3c3c] bg-slate-50 dark:bg-[#1e1e1e]">
                    <button
                        onClick={onSkip}
